...
Pedirá autenticar con su rostro y mostrará un listado similar al de la pestaña de Personajes. Si presiona el corazón rojo, este personaje se eliminará de su lista de favoritos. En la parte superior derecha hay un candado que, al presionarlo, volverá a bloquear la vista.
...
En la pestaña superior **Features** del simulador, corroborar que el Face ID está activado para el dispositivo de simulación *(ver imagen 001)*.
